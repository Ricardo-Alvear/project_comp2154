...
import { Bell, Plus, Calendar, Trash2, Clock } from 'lucide-react';
		...
		<div className='w-full animate-in fade-in duration-700'>
			<div className='mb-10'>
				<h1 className='text-4xl font-serif font-black tracking-tighter text-slate-900 uppercase flex items-center gap-3'>
					<Bell className='text-blue-600' size={32} /> Notification
					Vault
				</h1>
			...
			<div className='space-y-4'>
				{loading ?
					<p className='text-center text-slate-400 animate-pulse uppercase text-[10px] font-bold tracking-widest'>
